...
var _authheader = _interopRequireDefault(require("../AuthHeader/authheader"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

// import { UserRole } from "../helpers/authHelper"
var userData = _authheader["default"].getCurrentUser().user;
...
function userManagment() {
  if (userData.role == "admin") {
    return [{
      ...
      label: 'Manage Users',
      to: "".concat(_defaultValues.adminRoot, "/dashboards/manage-users") // roles: [UserRole.Admin, UserRole.Editor],
      // subs: [
      // {
    ...
    // },
    {
      ...
      label: 'Inventory',
      to: "".concat(_defaultValues.adminRoot, "/inventory"),
      subs: [{
        icon: 'simple-icon-check',
        label: 'Products',
        to: "".concat(_defaultValues.adminRoot, "/inventory/products")
      }, {
        icon: 'simple-icon-calculator',
        label: 'Variants',
        to: "".concat(_defaultValues.adminRoot, "/inventory/variants")
      } // {
...
var data = userManagment();
var _default = userManagment;
